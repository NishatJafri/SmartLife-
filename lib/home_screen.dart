...
class _HomeScreenState extends State<HomeScreen>
  ...
  Widget _welcomeCard() {
    return AnimatedContainer(
      ...
      child: Row(
        children: [
          const CircleAvatar(radius: 40, backgroundImage: AssetImage('assets/user_avatar.png')),
  ...
  Widget _aiSuggestionPanel() {
    ...
    if (moodPrediction.contains('Excellent') || moodPrediction.contains('Good')) {
      suggestion = "Amazing job, Nishat! Keep riding this momentum 🌟";
  ...
  Widget _profilePage() {
    return Padding(
      padding: const EdgeInsets.all(16.0),
      child: Column(children: [
        const CircleAvatar(radius: 50, backgroundImage: AssetImage('assets/user_avatar.png')),
        const SizedBox(height: 16),
        const Text('Nishat Jafri', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
        const SizedBox(height: 8),
        const Text('nishatjafri@gmail.com', style: TextStyle(fontSize: 16, color: Colors.grey)),
        const SizedBox(height: 20),
